...
A public demo site (Latvian UI) with two working prototypes for a Latvian real-estate & forest
...
1. `/` — hero: "Meža inventarizācijas un līgumu datu automatizācija — demo"; three-step "Kā tas
   strādā"; two cards → `/mezs`, `/ligumi`; link "Lēmumi" → `/lemumi`; footer: GitHub, author.
